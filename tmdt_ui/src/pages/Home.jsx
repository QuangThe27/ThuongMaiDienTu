...
function Home() {
    ...
    useEffect(() => {
        if (hash === '#product-section') {
            ...
            if (element) {
                // Đợi một chút để sản phẩm load xong (nếu cần) hoặc cuộn ngay
                setTimeout(() => {
    ...
    return (
        <div className="w-full bg-white">
            ...
            <div className="container mx-auto px-4 py-12">
                ...
                {/* Grid Sản phẩm */}
                <div id="product-section" className="scroll-mt-32"> {/* Thêm id và scroll-mt để không bị Header che khuất */}
                    {loading ? (
