    ...
    if (cartItems.length === 0) {
        return (
            <div className="pt-40 text-center">
                <p className="text-gray-400 font-bold uppercase italic mb-4">
                    Không có sản phẩm nào để thanh toán
                </p>
                <Link to="/cart" className="text-sky-500 font-black border-b-2 border-sky-500">
                    QUAY LẠI GIỎ HÀNG
                </Link>
            </div>
        );
        ...
        <div className="bg-white min-h-screen pt-32 pb-20">
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                <div className="flex items-center justify-between mb-12 border-b-4 border-black pb-6">
                    <Link
                        to="/cart"
                        className="flex items-center gap-2 font-black uppercase text-sm hover:text-sky-500 transition-all"
                    >
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <input
                                            ...
                                            onChange={() =>
                                                setFormData({ ...formData, payment_method: 0 })
                                            }
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <input
                                            ...
                                            onChange={() =>
                                                setFormData({ ...formData, payment_method: 1 })
                                            }
                                            className="w-5 h-5 accent-black"
                                        />
                                        <div>
                        ...
                        <div className="bg-gray-50 p-8 sticky top-32 border-t-8 border-sky-500 shadow-xl">
                                    ...
                                    return (
                                        <div key={item.id} className="flex gap-4 group">
                                            ...
                                            <div className="flex-1">
                                                <h4 className="font-black text-sm uppercase leading-tight mb-1 line-clamp-1">
                                                    {item.product_name}
                                                </h4>
                            ...
                            <div className="space-y-4 border-t-2 border-dashed border-gray-300 pt-6">
                                ...
                                <div className="flex justify-between items-baseline pt-4 border-t-2 border-black">
                                    ...
                                    <span className="text-4xl font-black text-sky-600 tracking-tighter">
